...
export const EntryCreationBar = ({setSelectedEntry, selectedEntry, mappedCategories, setSelectedCategories, AddEntry, setShowMore, showMore}) => {
                    ...
                    <Row className="entryCreationBar">
                        <Col>
                            <Form.Group>
                                ...
                                <Form.Control type="text" placeholder="Name eintragen" onChange={() =>{
                                    console.log("Selected Entry:",selectedEntry)
                                 setSelectedEntry()}} value={ selectedEntry != null ? selectedEntry.name : null} />
                            </Form.Group>
                        </Col>
                        <Col>
                            <Form.Group>
