...
public class InflationServiceService {
    ...
    public ResponseEntity<InflationDto> getLatestInflationData() {
        ...
        try {
            ...
            dto.setInflationValueInPercent(
                    Double.parseDouble(jsonObject.get("InflationRateRounded").toString()));

            return new ResponseEntity<>(dto, HttpStatus.OK) ;
        }catch (Exception e){
            log.error("Failed to parse json from api. Exception: "+ e);
